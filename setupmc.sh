...
case $1 in
    vanilla|v)
        ...
        echo "java -jar server.jar -xmx 4G" >> vanilla-$ver/start
        chmod +x vanilla-$ver/start
        echo "sudo screen ~/servers/minecraft/vanilla-$ver/start -d -S vanilla-$ver" >> vanilla-$ver/screen
    ...
    paper|p)
        ...
        echo "java -jar server.jar -xmx 8G" >> paper-$ver/start
        chmod +x paper-$ver/start
        echo "sudo screen ~/servers/minecraft/paper-$ver/start -d -S paper-$ver" >> paper-$ver/screen
    ...
    forge|f)
        ...
        echo "java -jar server.jar -xmx 12G" >> forge-$ver/start
        chmod +x forge-$ver/start
        echo "sudo screen ~/servers/minecraft/forge-$ver/start -d -S forge-$ver" >> forge-$ver/screen
